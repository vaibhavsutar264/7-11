...
const SetPassword = () => {
  return (
    <div className="security-screen login-area">
      <div className="security-form login-form">
                <div className="security-form-header form-title">
                  <h5 className="security-form-title title">Set Password</h5>
                  <p className="security-form-subTitle sub-title">Generate new password</p>
                </div>
                <form action="#" method="post">
                <div className="input-group mb-3">
                    <span className="input-group-text security-input-icon" id="password">
                      <svg
                  ...
                  <div className="input-group">
                    <button type="submit" name="submit" className="customBtn-01">
                       Done
                    </button>
                  </div>
                </form>
